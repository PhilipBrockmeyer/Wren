...
namespace Wren.Emulation.MasterSystem
{
    ...
    */
    ...
    public class ReferenceImplementation : IRunnableSystemComponent, IInteruptableSystemComponent
    {
        public List<Int32> History;
        ...
        //public bool goingToirq = false;// used to execute 1 more instruction after an irq
        ...
        // Misc
        public int tmp, tmp1, tmp2, tmp3;
        public int PPC = 0; // previous PC - used by debugger
        public static int[] bitSet = { 1, 2, 4, 8, 16, 32, 64, 128 }; // lookup table for setting a bit of an 8-bit value using OR
        public static int[] bitRes = { 254, 253, 251, 247, 239, 223, 191, 127 }; // lookup table for resetting a bit of an 8-bit value using AND
        ...
        // flag tables
        public static bool[] parity = new bool[256];
        ...
        public static int SF = 0x80;
        public static int ZF = 0x40;
        public static int YF = 0x20;
        public static int HF = 0x10;
        public static int XF = 0x08;
        public static int VF = 0x04;
        public static int PF = 0x04;
        public static int NF = 0x02;
        public static int CF = 0x01;

        public String tag;

        static ReferenceImplementation()
        {
        ...
        */
        ...
        public int sign(int nn)
        {
            return nn - ((nn & 128) << 1);
        }

        public void rst(int ea)
        {
            cycle -= 11;
            push(PC);
            PC = ea;
        ...
        public void ld_A(int n, int cycles)
        {
            cycle -= cycles;
            A = n;
        }

        public void ld_B(int n, int cycles)
        {
            cycle -= cycles;
            B = n;
        }
        ...
        public void ld_C(int n, int cycles)
        {
            cycle -= cycles;
            C = n;
        }

        public void ld_D(int n, int cycles)
        {
            cycle -= cycles;
            D = n;
        }

        public void ld_E(int n, int cycles)
        {
            cycle -= cycles;
            E = n;
        }

        public void ld_H(int n, int cycles)
        {
            cycle -= cycles;
            H = n;
        }

        public void ld_L(int n, int cycles)
        {
            cycle -= cycles;
            L = n;
        }

        public void ld_HLi(int n, int cycles)
        {
            cycle -= cycles;
            pokeb(HL(), n);
        }
        ...
        /** LD (ea),nn */
        public void ld_ea_ind16(int nn)
        {
            pokew(peekw(PC), nn);
            PC += 2;
        }
        ...
        */
        public int addA_8(int value, int A)
        {
            tmp = (A + value) & 0xff;
            F = SZHVC_Add[(A << 8) | tmp];
            return tmp;
        ...
        */
        public int adcA_8(int value, int A)
        {
            int c = F & 1;
        ...
        */
        public void cpA_8(int value, int A)
        {
            int result = (A - value) & 0xff;
        ...
        */
        public int subA_8(int value, int A)
        {
            int result = (A - value) & 0xff;
            F = SZHVC_sub[(A << 8) | result];
            return result;
        ...
        */
        public int sbcA_8(int value, int A)
        {
            int c = F & 1;
            int result = (A - value - c) & 0xff;
        ...
        * RLD
        */
        public int rld_A(int A, int H, int L)
        {
            int result = A;
            int t = peekb(HL());
            int q = t;
        ...
        * RRD
        */
        public int rrd_A(int A, int H, int L)
        {
            int result = A;
            int t = peekb(HL());
            int q = t;
        ...
        */
        public void bit(int bitNumber, int value)
        {
        ...
        */
        public int set(int bitNumber, int value)
        {
        ...
        */
        public int res(int bitNumber, int value)
        {
        ...
        * AND - ok
        */
        public int andA(int value, int A)
        {
            A &= value;
            F = SZP[A] | 0x10;
            return A;
        ...
        * OR - ok
        */
        public int orA(int value, int A)
        {
            A |= value;
            F = SZP[A];
            return A;
        ...
        * XOR - ok
        */
        public int xorA(int value, int A)
        {
            A ^= value;
            F = SZP[A];
            return A;
        ...
        */
        ...
        public void portOut(int port, int value, int state)
        {
        ...
        * IN
        */
        public int portIn(int port, int hi)
        {
            int portIn = inb(port, hi);
            F = (F & 1) | SZP[portIn];
            return portIn;
        }
        ...
        {
            _bus.WritePort((Byte)port, (Byte)value);
        }

        public int inb(int port, int hi)
        {
            return _bus.ReadPort((Byte)port); //, (Byte)); //0xff;
        }

        public int peekb(int add)
        {
            //return memory[add & 0xffff] & 0xff;
            return _bus.ReadByte(add & 0xFFFF) & 0xFF;
        }

        public void pokeb(int add, int value)
        {
            //memory[add & 0xffff] = value & 0xff;
            _bus.WriteByte(add & 0xffff, (Byte)(value & 0xff));
        }
        ...
        * Undocumented
        */
        public int incL16(int value)
        {
            return (value & 0xff00) | inc8(value & 0xff);
        }

        public int decL16(int value)
        {
            return (value & 0xff00) | dec8(value & 0xff);
        }

        public int ldXYH_8(int val16, int val8)
        {
            return (val16 & 0xff) | (val8 << 8);
        }

        public int ldXYL_8(int val16, int val8)
        {
        ...
        * check interrupt
        */
        public int checkInterrupt(int cycle)
        {
            if (NMI || (IFF0 && IRQ))
            {
                if (NMI)
        ...
        * Illegal instruction
        */
        public void error(int instruction, int address)
        {
            Console.WriteLine("CPU error: illegal instruction $" + string.Format("{0:X} at ${1:X}", instruction, address));
            Environment.Exit(1);
        }

        public void debug(int instruction, int PPC, int A, int F, int B, int C, int D, int E,
